...
class FSOCODataset(BaseDataset):
    def __init__(self, download_url: str, raw_dir: str, preprocessed_dir: str, 
                 class_map: dict, debug_mode: bool = True, train_limit: int = 150, val_limit: int = 20):
        super().__init__(raw_dir=raw_dir, preprocessed_dir=preprocessed_dir, class_map=class_map)
